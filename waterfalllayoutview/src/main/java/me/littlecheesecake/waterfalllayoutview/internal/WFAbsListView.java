...
import me.littlecheesecake.waterfalllayoutview.R;
 ...
 */
public abstract class WFAbsListView extends WFAdapterView<ListAdapter> implements
ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnTouchModeChangeListener {
     ...
     * {@link me.littlecheesecake.waterfalllayout.internal.WFAbsListView.OnScrollListener}.
     */
    ...
    public interface OnScrollListener {
         ...
         */
        void onScrollStateChanged(WFAbsListView view, int scrollState);
         ...
         */
        public void onScroll(WFAbsListView view, int firstVisibleItem, int visibleItemCount,
                             int totalItemCount);
    }

    @TargetApi(Build.VERSION_CODES.KITKAT)
    public WFAbsListView(Context context) {
        super(context);
        initAbsListView();
    ...
    public WFAbsListView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.absListViewStyle);
    }

    public WFAbsListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public boolean showContextMenuForChild(View originalView) {
        ...
        if (longPressPosition >= 0) {
            ...
            if (mOnItemLongClickListener != null) {
                handled = mOnItemLongClickListener.onItemLongClick(WFAbsListView.this, originalView,
