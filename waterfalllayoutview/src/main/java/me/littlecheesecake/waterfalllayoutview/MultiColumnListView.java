...
import me.littlecheesecake.waterfalllayoutview.internal.ParcelableSparseIntArray;
import me.littlecheesecake.waterfalllayoutview.internal.WFAbsListView;
import me.littlecheesecake.waterfalllayoutview.internal.WFListView;

/**
 * @author yulu
 * from  git@github.com:GDG-Korea/PinterestLikeAdapterView.git
 */
public class MultiColumnListView extends WFListView {
	...
	private void init(AttributeSet attrs) {
		...
		if( attrs == null ){
			...
			int landColNumber = a.getInteger(R.styleable.MultiColumnListView_wflLandscapeColumnNumber, -1);
			int defColNumber = a.getInteger(R.styleable.MultiColumnListView_wflColumnNumber, -1);
			...
			mColumnPaddingLeft = a.getDimensionPixelSize(R.styleable.MultiColumnListView_wflColumnPaddingLeft, 0);
			mColumnPaddingRight = a.getDimensionPixelSize(R.styleable.MultiColumnListView_wflColumnPaddingRight, 0);
			a.recycle();
		}
    ...
    public OnScrollListener scroller = new OnScrollListener() {
        ...
        @Override
        public void onScrollStateChanged(WFAbsListView view, int scrollState) {
        ...
        @Override
        public void onScroll(WFAbsListView view, int firstVisibleItem,
